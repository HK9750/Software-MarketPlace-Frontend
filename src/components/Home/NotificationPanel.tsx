          ...
          notifications.map((notification) => (
            <div
              ...
              className={`p-4 border-b last:border-b-0 ${
                notification.isRead ? "bg-background" : "bg-blue-50 dark:bg-blue-900/20"
              }`}
            >
              <div className="flex items-start gap-3">
                {!notification.isRead && <Circle className="h-2 w-2 mt-2 flex-shrink-0 fill-blue-500 text-blue-500" />}
