...
export default function ProductDetails({ product }: { product: Product }) {
  ...
  const websiteUrl =
    product?.seller.websiteLink.startsWith("http")
  ...
  const selectedPrice =
    hardcodedLicenseOptions.find((option) => option.duration === selectedLicense)
      ?.price || product.price;
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Choose the licensing period that suits your needs
                </CardDescription>
              </CardHeader>
              <CardContent>
                <RadioGroup
                ...
                >
                  {hardcodedLicenseOptions.map((option) => (
                    <div key={option.duration}>
                      ...
                      >
                        <span className="mb-3">{option.duration}</span>
          ...
          <TabsContent value="reviews">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Average Rating: {product.averageRating.toFixed(1)} out of 5
                </CardDescription>
              </CardHeader>
              <CardContent>
